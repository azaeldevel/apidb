...
#line 37 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:404
...
#line 51 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:412
...
#line 65 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:413
...
namespace apidb {
#line 151 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:479
  ...
  Parser::symbol_type
  Parser::make_NUMERIC (const location_type& l)
  {
    return symbol_type (token::NUMERIC, l);
  }
  ...
  Parser::symbol_type
  Parser::make_PARENTHESIS_OPEN (const location_type& l)
  {
    return symbol_type (token::PARENTHESIS_OPEN, l);
  }

  Parser::symbol_type
  Parser::make_PARENTHESIS_CLOSE (const location_type& l)
  {
    return symbol_type (token::PARENTHESIS_CLOSE, l);
  }
  ...
  Parser::symbol_type
  Parser::make_UNKNOW (const location_type& l)
  {
    return symbol_type (token::UNKNOW, l);
  }
...
#line 85 "parser.yy" // lalr1.cc:859
    {std::cout<<"const char*";}
#line 828 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:859
    break;

  case 3:
#line 86 "parser.yy" // lalr1.cc:859
    {std::cout<<"int";}
#line 834 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:859
    break;

  case 4:
#line 87 "parser.yy" // lalr1.cc:859
    {std::cout<<"int";}
#line 840 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:859
    break;

  case 5:
#line 88 "parser.yy" // lalr1.cc:859
    {std::cout<<"const char*";}
#line 846 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:859
    break;

  case 6:
#line 89 "parser.yy" // lalr1.cc:859
    {std::cout<<"double";}
#line 852 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:859
    break;


#line 856 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:859
            default:
              break;
            }
        }
  ...
  Parser::yypact_[] =
  {
      -5,     0,     0,   -26,   -26,   -26,   -26,   -26,   -26,   -26,
       0,     3,     0,   -25,     0,   -19,   -26,   -26,   -26,   -26,
     -26,   -26,   -26,     5,   -26,     6,   -16,   -11,   -26,    11,
      -8,   -26
  };
  ...
  Parser::yydefact_[] =
  {
       0,     0,     0,    12,    13,    14,    15,    16,     9,     8,
      10,     0,     0,     0,     0,     0,    17,    18,     4,     3,
       2,     1,     5,     0,     6,     0,     0,     0,     7,     0,
       0,    11
  };
  ...
  Parser::yytable_[] =
  {
      16,     1,     2,    21,    23,     3,     4,     5,     6,     7,
      25,    19,    26,    27,    28,     8,     9,    29,    30,    20,
      10,    22,    31,    24,     0,     0,     0,     0,     0,     0,
       0,     0,    17
  };
  ...
  Parser::yycheck_[] =
  {
       0,     6,     7,     0,    29,    10,    11,    12,    13,    14,
      29,     2,     7,     7,    30,    20,    21,    28,     7,    10,
      25,    12,    30,    14,    -1,    -1,    -1,    -1,    -1,    -1,
      -1,    -1,    32
  };
  ...
  Parser::yystos_[] =
  {
       0,     6,     7,    10,    11,    12,    13,    14,    20,    21,
      25,    35,    36,    37,    38,    39,     0,    32,    40,    40,
      40,     0,    40,    29,    40,    29,     7,     7,    30,    28,
       7,    30
  };
  ...
  Parser::yyr1_[] =
  {
       0,    34,    35,    35,    35,    35,    35,    36,    37,    37,
      37,    38,    39,    39,    39,    39,    39,    40,    40
  };
  ...
  {
  "\"end of file\"", "error", "$undefined", "TINYINT", "SMALLINT",
  "MEDIUMINT", "INT", "INTEGER", "BIGINT", "BIT", "DECIMAL", "NUMERIC",
  "REAL", "FLOAT", "DOUBLE", "DATE", "DATETIME", "TIMESTAMP", "TIME",
  "YEAR", "CHAR", "VARCHAR", "BINARY", "VARBINARY", "BLOB", "TEXT", "ENUM",
  "SET", "COMA", "PARENTHESIS_OPEN", "PARENTHESIS_CLOSE", "SPACE",
  "NEWLINE", "UNKNOW", "$accept", "declare_type", "stringVarible",
  "stringVariableTypes", "integerVariable", "integerVariableTypes",
  "declare_end", YY_NULLPTR
  };
  ...
  Parser::yyrline_[] =
  {
       0,    85,    85,    86,    87,    88,    89,    91,    93,    93,
      93,    95,    97,    97,    97,    97,    97,    99,    99
  };
...
#line 1203 "/home/areyes/softdev/apibd/src/generator-sql/parser.tab.cc" // lalr1.cc:1167
