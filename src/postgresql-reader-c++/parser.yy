...
%debug 
%defines 
%define api.namespace {octetos::apidb::postgresql}
...
%parse-param { postgresql::Scanner  &scanner  }
%parse-param { postgresql::Analyzer  &driver  }
...
void 
octetos::apidb::postgresql::Parser::error(const location_type &l, const std::string &err_message)
{
	driver.oneLine =  "";
